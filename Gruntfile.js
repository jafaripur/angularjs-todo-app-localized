...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        banner: '/*! <%= pkg.name %> - v<%= pkg.version %> - ' +
                ...
                '<%= pkg.author.name %>; Licensed NEW BSD */',
        // Project settings
        yeoman: appConfig,
        ...
        cssmin: {
            ...
            dist: {
                ...
                files: [{
                        ...
                        expand: true,
                        cwd: '<%= yeoman.dist %>/bower_components/bootstrap-rtl/dist/css',
                        src: ['*.css', '!*.min.css'],
                        dest: '<%= yeoman.dist %>/bower_components/bootstrap-rtl/dist/css',
                        ext: '.css'
                    }]
        ...
        'json-minify': {
            build: {
                files: '<%= yeoman.dist %>/locales/**/*.json'
            }
        },
        usebanner: {
            dist: {
